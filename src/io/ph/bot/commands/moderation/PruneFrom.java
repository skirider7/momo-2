 ...
 * Start from inputted message
 * Does not actually do anything different yet (7/4/17)
 * @author Skirider7, extending Paul
 */
@CommandData (
		defaultSyntax = "prunefrom",
		aliases = {},
		category = CommandCategory.MODERATION,
		permission = Permission.KICK,
		description = "Prune n messages (default 40, up to 75). Enter a message ID to ignore that and all more recent messages.\n",
		example = "25 @target\n"
				+ "50\n"
				+ "@target"
		)
